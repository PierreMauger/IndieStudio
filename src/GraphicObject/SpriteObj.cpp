...
void SpriteObj::draw(Camera &camera)
{
    ...
    DrawTexturePro(*this->_texture.get(), {0, 0, this->_coords.x, this->_coords.y}, {this->_pos.x * width / 2 + width / 2, this->_pos.y * height / 2 + height / 2, this->_scale.x * width, this->_scale.y * height}, {0, 0}, 0, WHITE);
}
